...
// var map = new L.Map('map', {center: center, zoom: 11, maxZoom: maxZoom, layers: [basemap]});

var basemap = new L.TileLayer(baseUrl, {maxZoom: 17, attribution: baseAttribution, subdomains: subdomains, opacity: opacity});

var center = new L.LatLng(1.3601664,103.8251833);

var map = new L.Map('map', {center: center, zoom: 11,layers: [basemap]});
